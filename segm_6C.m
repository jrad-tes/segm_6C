...
% The script was run and tested using MATLAB 9.1.0.441655 (2016b) for MAC
%   on a macOS 10.12.6 (Sierra) machine.
%
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% COMMENTS
% Dependencies
%   - FielTrip 20170326 (http://www.fieldtriptoolbox.org) (Oostenveldt et
%   al., 2011, Data. Comput. Intell. Neurosci.)
